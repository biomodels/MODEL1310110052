# MODEL1310110052: MODEL1310110052
...
`pip install git+https://github.com/biomodels/MODEL1310110052.git`

To install a specific version (in this example, from the 2014-09-16 BioModels release)

`pip install git+https://github.com/biomodels/MODEL1310110052.git@20140916`

## Usage

Importing the model package.

`import MODEL1310110052 as model`
...
The model of nasopharynx respiratory epithelial cells metabolism is derived
...
and identified by:
[MODEL1310110052](http://identifiers.org/biomodels.db/MODEL1310110052) .
